  ...
  return (
    <>
      <div className="testimonial__item splide__slide">
        <div className="testimonial__message">
          <p className="description">
            Properland team was fantastic! We met at a house showing over a year
            ago and he took time out of their day to describe the home buying
            process to us. In the following year we found the house.
          </p>
        </div>
      ...
      <div className="testimonial__item splide__slide">
        <div className="testimonial__message">
          <p className="description">
            ...
            and that I could trust to send me listings that wouldn’t be a waste.
          </p>
          <p className="description">
            I’m grateful to have worked with properland and will surely want to
            work with again.
          </p>
        </div>
        <div className="testimonial__user">
      ...
      <div className="testimonial__item splide__slide">
        <div className="testimonial__message">
          <p className="description">
            I used Properland to sell my house in south Manchester, they first
            came our to give me a valuation which I was happy with the interest
            generated and the speed of the whole process.
          </p>
        </div>
        <div className="testimonial__user">
          <div className="testimonial__image">
      ...
      <div className="testimonial__item splide__slide">
        <div className="testimonial__message">
          <p className="description">
            I recently worked with properland in identifying and purchasing an
            investment property in San Francisco, and they made the process
      ...
      <div className="testimonial__item splide__slide">
        <div className="testimonial__message">
          <p className="description">
            We used Properland to buy our first house, they were very helpful
            and professional always quick in responding to our emails and giving
            us regular updates. We would highly recommend them.
          </p>
        </div>
        <div className="testimonial__user">
          <div className="testimonial__image">
